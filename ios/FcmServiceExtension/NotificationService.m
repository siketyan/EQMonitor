...
// #import "FirebaseAuth.h" // Add this line if you are using FirebaseAuth phone
// authentication #import <UIKit/UIKit.h> // Add this line if you are using
// FirebaseAuth phone authentication
...
{ if ([[FIRAuth auth] canHandleURL:url]) { return YES;
  }
  return NO;
}

- (void)scene:(UIScene *)scene openURLContexts:(NSSet<UIOpenURLContext *>
*)URLContexts { for (UIOpenURLContext *urlContext in URLContexts) {
